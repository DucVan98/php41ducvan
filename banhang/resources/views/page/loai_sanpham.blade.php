...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Sản phẩm {{$loai_spp->name}}</h6>
			</div>
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if($sp->promotion_price == 0)
												<span class="flash-del"style="text-decoration: none;color: #f90">${{$sp->unit_price}}</span>
												@else
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if($spk->promotion_price == 0)
												<span class="flash-del"style="text-decoration: none;color: #f90">${{$spk->unit_price}}</span>
												@else
