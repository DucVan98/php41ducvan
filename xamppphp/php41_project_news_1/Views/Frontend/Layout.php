...
<title>Home</title>
<base href="http://phamducvan98.byethost14.com/" target="_blank, _self, _parent, _top">
<link href="Assets/Frontend/css/styles.css" rel="stylesheet" type="text/css" />
<link href="Assets/Frontend/css/bootstrap.css" rel="stylesheet" type="text/css" />

<!--[if  IE]>
<link rel="stylesheet" type="text/css" href="Assets/Frontend/css/ie.css" />
<![endif]-->
...
<body class="home">
    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div class="logo">
                <a href="index-2.html"><img src="Assets/Frontend/img/logo.png" alt=""></a>
            ...
            <nav class="menu">
                <ul>
                    <li><span class="border-bottom"></span><a href="home">Trang chủ</a></li>
        ...
        <?php 
            //MVC tin noi bat
            //include file controller in MVC
                ...
                <div class="right-container">
                    <div class="sidebar">
                       ...
                       <?php 
                            ...
                            //goi den action trong Controller
                            $obj->index();
                        ?>
                        <div class="widget">
                        ...
                        <div class="widget">
                            ...
                            <img class="ads" src="Assets/Frontend/img/ads.jpg" alt="">
                            <div class="clear"></div>
                        </div>
...
<script type="text/javascript" src="Assets/Frontend/js/jquery-1.8.3.min.js" ></script>
<script type="text/javascript" src="Assets/Frontend/js/html5shiv.js" ></script>
<script type="text/javascript" src="Assets/Frontend/js/bootstrap.min.js" ></script>
<script type="text/javascript" src="Assets/Frontend/js/fancydropdown.js" ></script>
