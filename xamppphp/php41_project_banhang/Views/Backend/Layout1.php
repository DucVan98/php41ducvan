                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="Assets/Backend/layout1/images/156896762967870923_2436875506545672_5460396488402141184_n.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo $_SESSION["email"]; ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="Assets/Backend/layout1/images/156896762967870923_2436875506545672_5460396488402141184_n.jpg" class="img-circle" alt="User Image">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?area=Backend&controller=Category">
                        <i class="fa fa-th"></i> <span>Danh mục quần áo</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?area=Backend&controller=Garment">
                        <i class="fa fa-th"></i> <span>Danh sách quần áo</span>
                    </a>
                </li>
                <li>
