...
<!-- Mirrored from onshop.asia/demo-theme/fashion_zork_2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2019 11:23:47 GMT -->
<head>
    <title>Title</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <!-- Section intro sales -->
    <section id="block-sale-title" class="block-header-sale main-color text-center sticky-top">
        <div class="container-fluid">
            <p class="content-font">
                Với Zorka - Tự tin xuống phố - SALE OFF 50% sản phẩm trong tháng 4
            </p>
        </div>
    </section>
    <!-- ./Section intro sales -->
  ...
  <?php include "Views/Frontend/HeaderView.php"; ?>
    ...
    <!-- Menu -->
    <!-- Khi ẩn thanh thông báo thêm class 'fxd-top' -->
   
    <!-- /.Menu -->

    <!-- Slideshow -->
    <section id="block-slideshow" class="block-slideshow">
        <div class="owl-carousel owl-slide owl-banner" data-time="3000">
            <div class="item">
                <img src="Assets/Frontend/images/slider.png" alt="">
            </div>
            <div class="item">
                <img src="Assets/Frontend/images/slider.png" alt="">
            </div>
    ...
    <!-- block-ads-banner -->
    <div id="block-ads-bottom-banner" class="block-ads-banner block-ads-big">
        <img width="100%" src="Assets/Frontend/images/banner.png" alt="">
    </div>
    <!-- /.block-ads-banner -->

    <!-- block-blog -->
    <div id="block-blog" class="block-blog">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="blog-item">
                        <div class="thumb">
                            <a href="#"><img class="img-fluid" src="images/image2.png" alt=""></a>
                        </div>
                        <div class="content">
                            <h5 class="name">
                                <a href="#">Zorka Spring/Summer Collection</a>
                            </h5>
                            <div class="meta">
                            ...
                            <div class="view">3.500 lượt xem</div>
                            <div class="desc">
                                <p>Now, what better way is there to get clothing you’re sure to love than by making it
                                    yourself? Did you know that there are clubs you can join that will not </p>
                            </div>
                            <div class="view-more">
                                <a class="header-color " href="#">Đọc tiếp</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="blog-item">
                        <div class="thumb">
                            <a href="#"><img class="img-fluid" src="images/image3.png" alt=""></a>
                        </div>
                        <div class="content">
                            <h5 class="name">
                                <a href="#">White Vintage Back Pack For Girl</a>
                            </h5>
                            <div class="meta">
                                <span class="date">14/04/2019</span>
                                bởi
    ...
    <!-- block-partner -->
    <div id="block-partner" class="block-partner">
        <div class="container">
            <div class="owl-carousel owl-theme owl-partner">
                ...
                <div class="item">
                    <img src="images/patner3.png" alt="">
                </div>
                <div class="item">
                    <img src="images/patner4.png" alt="">
                </div>
                <div class="item">
                    <img src="images/patner5.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer id="block-footer" class="block-footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="widget-footer">
                        ...
                        <div class="contact-item clearfix">
                            <span>Email</span>
                            <a href="#">suppcom.zorka@gmail.orka</a>
                        </div>
                        <div class="contact-item clearfix">
                            <span>SĐT</span>
                        ...
                        <div class="contact-item clearfix">
                            <span>Địa chỉ</span>
                            <a href="#">Số nhà 65, ngách 322/76 đường Mỹ Đình, Quận Nam Từ Liêm</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-2">
                    <div class="widget-footer">
                        <h5 class="header-font">Liên Kết nhanh</h5>
                        <ul>
                            <li><a href="#">Trang chủ</a></li>
                            <li><a href="#">Sản phẩm</a></li>
                            <li><a href="#">Bài viết</a></li>
                            <li><a href="terms-conditions.html">Điều khoản dịch vụ</a></li>
                ...
                <div class="col-sm-6 col-md-2">
                    <div class="widget-footer">
                        <h5 class="header-font">Tài khoản</h5>
                        <ul>
                ...
                <div class="col-md-4">
                    <div class="widget-footer">
                        <h5 class="header-font">Đăng ký theo dõi Zorka!</h5>
                                ...
                                <li>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="27"
                                            viewBox="0 0 39 27" fill="none">
                                            <path
                                                d="M37.6719 4.21875C37.4375 3.375 37.0156 2.64844 36.4062 2.03906C35.7969 1.42969 35.0703 1.00781 34.2266 0.773438C33.0078 0.445312 30.1484 0.210938 25.6484 0.0703125L19.25 0L12.8516 0.0703125C8.35156 0.210938 5.49219 0.445312 4.27344 0.773438C3.42969 1.00781 2.70312 1.42969 2.09375 2.03906C1.48438 2.64844 1.0625 3.375 0.828125 4.21875C0.5 5.48438 0.265625 7.40625 0.125 9.98438C0.078125 11.2969 0.0546875 12.4688 0.0546875 13.5L0.125 17.0156C0.265625 19.6406 0.5 21.5859 0.828125 22.8516C1.0625 23.6484 1.48438 24.3516 2.09375 24.9609C2.70312 25.5703 3.42969 25.9922 4.27344 26.2266C5.49219 26.5547 8.35156 26.7891 12.8516 26.9297L19.25 27L25.6484 26.9297C30.1484 26.7891 33.0078 26.5547 34.2266 26.2266C35.0703 25.9922 35.7969 25.5703 36.4062 24.9609C37.0156 24.3516 37.4375 23.6484 37.6719 22.8516C38 21.5859 38.2344 19.6406 38.375 17.0156L38.4453 13.5L38.375 9.98438C38.2344 7.40625 38 5.48438 37.6719 4.21875ZM15.3125 19.2656V7.80469L25.3672 13.5L15.3125 19.2656Z"
                                                fill="#969696" />
                                        </svg>
                                    </a>
                                </li>
                        ...
                        <span class="mb-2">Đừng bỏ lỡ hàng ngàn sản phẩm và chương trình siêu hấp dẫn!</span>
                        <form action="#">
                            <div class="form-group custom-input">
                                ...
                                <button type="submit" class="btn btn-submit main-color">Gửi</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="copy-right">
            <div class="container text-center">
                Powered by <a class="dev" href="#">Onshop</a>.
            </div>
        </div>
    </footer>
    <!-- /.block-footer -->
