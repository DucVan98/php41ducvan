    ...
    <div class="row">
        ...
        <article>
			<div class="cat-post-desc">
				...
				<p><a href="index.php?controller=NewsDetail&id=<?php echo $rows->id; ?>"><img class="img_category" src="Assets/upload/news/<?php echo $rows->img; ?>" style="width:200px;" alt=""></a><?php echo $rows->description; ?></p>
			</div>
			<div class="clear"></div>
