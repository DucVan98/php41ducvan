	...
	<div class="container">
	  <div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
		  <div class="wrapper-mini-cart"> <span class="icon"><i class="fa fa-shopping-cart"></i></span> <a href="cart"> 
		  	<?php 
			  ...
			  <div class="has-items">
				<ul class="list-unstyled">
				  ...
				  <li class="clearfix" id="item-1853038">
					<div class="image"> <a href="index.php?controller=ProductDetail&id=<?php echo $product['id']; ?>"> <img alt="<?php echo $product['name']; ?>" src="Assets/upload/product/<?php echo $product['img']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive"> </a> </div>
					<div class="info">
					  <h3><a href="index.php?controller=ProductDetail&id=<?php echo $product['id']; ?>"><?php echo $product['name']; ?></a></h3>
